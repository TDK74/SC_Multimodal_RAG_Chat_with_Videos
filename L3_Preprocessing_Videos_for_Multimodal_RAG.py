...
## ------------------------------------------------------ ##
vid2_url = ("https://multimedia-commons.s3-us-west-2.amazonaws.com/data/videos/mp4/010/a07/"
            "010a074acb1975c4d6d6e43c1faeb8.mp4")
...
## ------------------------------------------------------ ##
def extract_and_save_frames_and_metadata(path_to_video,
                                        path_to_transcript,
    ...
    for idx, transcript in enumerate(trans):
        ...
        if success:
            ...
            metadata = {'extracted_frame_path' : img_fpath,
                        'transcript' : text,
...
## ------------------------------------------------------ ##
def extract_and_save_frames_and_metadata_with_fps(path_to_video,
                                                path_to_save_extracted_frames,
                                                path_to_save_metadatas,
...
metadatas = extract_and_save_frames_and_metadata_with_fps(vid2_filepath,
                                                        extracted_frames_path,
                                                        metadatas_path,
